...
@section('content')
    <div class="container mx-auto pt-8 px-4 sm:px-8 flex justify-center items-center min-h-full">
        <div class="w-full max-w-md">
            <h1 class="text-2xl font-semibold text-gray-900 mb-6">Edit Hauling Route Weather</h1>

            <form action="{{ route('hauling-route-weather.update', $haulingWeather->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <button type="button" onclick="toggleRouteDropdown()"
                            ...
                            <span id="selectedRoute">{{ $haulingWeather->hauling_route->route_name ?? 'Pilih Rute Hauling' }}</span>
                    ...
                    <input type="hidden" name="route_id" id="hauling_route_id"
                        value="{{ $haulingWeather->route_id }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="kilometer" id="kilometer"
                        value="{{ $haulingWeather->kilometer }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="latitude" id="latitude" value="{{ $haulingWeather->latitude }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="longitude" id="longitude" value="{{ $haulingWeather->longitude }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="weather_condition" id="weather_condition"
                        value="{{ $haulingWeather->weather_condition }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        required>
                </div>
