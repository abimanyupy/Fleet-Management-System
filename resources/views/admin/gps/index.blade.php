    ...
    <div class="container mx-auto px-4 sm:px-8 ">
        <div class="py-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-900">GPS List</h1>
            ...
            <div class="mb-6">
                <form action="{{ route('gps.index') }}" method="GET" class="flex">
                    <div class="relative flex-grow">
                        <input type="text" name="search" placeholder="Search by license plates, device id..."
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($gpsLoc as $gps)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $gps->trucks->number_plate }}
                                </td>
                ...
                <div class="mb-4 mx-4">
                    {{ $gpsLoc->appends(['search' => request('search')])->links() }}
                </div>
            </div>
        </div>
    </div>
